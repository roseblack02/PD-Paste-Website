<%@ Page Title="Hand Printed T-Shirt Medium" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="handPrintedM.aspx.cs" Inherits="AssignmentSite.products.handPrintedM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="content">
        ...
        <span class="description">
            ...
            Hand printed t-shirt size medium

            <br/>
            <br/>

            <div style="display: block; margin-left: auto; margin-right: auto;">
                <asp:Label ID="lblSize" runat="server" Text="Size selected: Medium"></asp:Label>
