<%@ Page Title="Hand Printed T-Shirt Large" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="handPrintedL.aspx.cs" Inherits="AssignmentSite.products.handPrintedL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="content">
        ...
        <span class="description">
            ...
            Hand printed t-shirt size large

            <br/>
            <br/>

            <div style="display: block; margin-left: auto; margin-right: auto;">
                <asp:Label ID="lblSize" runat="server" Text="Size selected: Large"></asp:Label>
