<%@ Page Title="Videos" Language="C#" MasterPageFile="~/masterPage.Master" AutoEventWireup="true" CodeBehind="videos.aspx.cs" Inherits="AssignmentSite.videos" %>
    ...
    <div id="content" >
        ...
        <div class="columns" id="popular" >
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [tblArticle] WHERE ([Category] = ?) ORDER BY [Views] DESC">
                <SelectParameters>
                    <asp:Parameter DefaultValue="Videos" Name="Category" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
